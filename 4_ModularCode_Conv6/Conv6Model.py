""" Conv2Model for initialization of VGG Convoultional Neural Network """
...
class pruned_nn():
    ...
    def pruned_nn(pruning_params_conv, pruning_params_fc, pruning_params_op):
        ...
        pruned_model.add(prune_low_magnitude(
            Conv2D(filters=64, kernel_size=(3, 3),activation=config["activation_function"], kernel_initializer=init,
        ...
        pruned_model.add(prune_low_magnitude(
            Conv2D(
                filters=128, kernel_size=(3, 3), activation=config["activation_function"], kernel_initializer=init,
        ...
        pruned_model.add(prune_low_magnitude(
            Conv2D(
                filters=256, kernel_size=(3, 3), activation=config["activation_function"], kernel_initializer=init,
                strides=(1, 1), padding='same'),
            **pruning_params_conv))
