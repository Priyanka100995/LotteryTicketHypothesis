...
if Pruning == '20% from every layer':
        ...
        while loc_tot_params >= max_pruned_params:
                ...
                loc_conv3 *= config["conv_pruning"]  # 10% weights are pruned
                loc_conv4 *= config["conv_pruning"]  # 10% weights are pruned
                ...
                loc_tot_params = loc_conv1 + loc_conv2 + loc_conv3 + loc_conv4 + loc_dense1 + loc_dense2 + loc_op_layer

                n += 1

                print("Conv1 = {0:.3f}, Conv2 = {1:.3f}, Conv3 = {2:.3f}, Conv4 = {3:.3f},  Dense1 = {4:.3f}, Dense2 = {5:.3f} & O/p layer = {6:.3f}".format(
                        loc_conv1, loc_conv2, loc_conv3, loc_conv4, loc_dense1, loc_dense2, loc_op_layer))
        ...
        for i in range(1, num_pruning_rounds + 1):
                ...
                print(
                        "Conv1 = {0:.3f}, Conv2 = {1:.3f}, Conv3 = {2:.3f}, Conv4 = {3:.3f},  Dense1 = {4:.3f}, Dense2 = {5:.3f} & O/p layer = {6:.3f}".format(
                                loc_conv1, loc_conv2, loc_conv3, loc_conv4, loc_dense1, loc_dense2, loc_op_layer))
                print("Total number of parameters = {0:.3f}\n".format(loc_tot_params))
                loc_tot_params = loc_conv1+ loc_conv2+ loc_conv3+ loc_conv4+ loc_dense1 + loc_dense2 + loc_op_layer
